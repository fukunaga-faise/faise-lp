      ...
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        <div className="overflow-hidden mb-10 md:mb-14">
          <motion.h2
            ...
            className="text-[clamp(30px,6vw,72px)] font-black leading-[1.1] tracking-tight text-[#0f0f0f]"
          >
            広告運用だけでは、
            <br />
            <span className="text-[#bbb]">人は来ない。</span>
          </motion.h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-0">
          <div className="mb-10 md:mb-0">
            {pains.map((pain, i) => (
              ...
              >
                <span className="font-inter text-xs font-bold text-[#0050d0]/50 mt-0.5 w-6 shrink-0">
                  {String(i + 1).padStart(2, '0')}
                </span>
                <p className="text-[clamp(14px,2vw,17px)] text-[#555] leading-relaxed"
          ...
          >
            <div className="border-l-2 border-[#0050d0] pl-6">
              <p className="text-[clamp(16px,2.2vw,22px)] font-bold leading-[1.8] text-[#333]">
                今必要なのは、広告運用ではなく、
                <br />
